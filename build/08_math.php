...
$x41 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('TypeError', $global), $line, $column, $file);
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x43->class) && $x43->class === 'Error' && !isset($x43->properties['file']) && !isset($x43->properties['line']) && !isset($x43->properties['column'])) {$x43->properties['file'] = $file;$x43->properties['line'] = $line;$x43->properties['column'] = $column;$x43->attributes['file'] = $x43->attributes['line'] = $x43->attributes['column'] = 0; }
...
$x36 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('arguments', $global), 52, 23, '<image>/08_math.js');
$_arguments =& $x36[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x36;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x37 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('ReferenceError', $global), 52, 23, '<image>/08_math.js');
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x39->class) && $x39->class === 'Error' && !isset($x39->properties['file']) && !isset($x39->properties['line']) && !isset($x39->properties['column'])) {$x39->properties['file'] = '<image>/08_math.js';$x39->properties['line'] = 52;$x39->properties['column'] = 23;$x39->attributes['file'] = $x39->attributes['line'] = $x39->attributes['column'] = 0; }
throw new JSException($x39, 52, 23, '<image>/08_math.js');
}
unset($x40, $W40, $S40, $U40);
$x46 = _420026a1fb085c6053dae1bd17e9a63a_13($global, $scope, $_arguments, JS::toString('length', $global), 52, 32, '<image>/08_math.js');
...
$x47 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('Infinity', $global), 52, 48, '<image>/08_math.js');
$_Infinity =& $x47[0]; list(,$WInfinity,$SInfinity,$UInfinity) = $x47;
if ($UInfinity) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x48 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('ReferenceError', $global), 52, 48, '<image>/08_math.js');
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x50->class) && $x50->class === 'Error' && !isset($x50->properties['file']) && !isset($x50->properties['line']) && !isset($x50->properties['column'])) {$x50->properties['file'] = '<image>/08_math.js';$x50->properties['line'] = 52;$x50->properties['column'] = 48;$x50->attributes['file'] = $x50->attributes['line'] = $x50->attributes['column'] = 0; }
...
$x57 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('isNaN', $global), 53, 8, '<image>/08_math.js');
$_isNaN =& $x57[0]; list(,$WisNaN,$SisNaN,$UisNaN) = $x57;
if ($UisNaN) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x58 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('ReferenceError', $global), 53, 8, '<image>/08_math.js');
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x60->class) && $x60->class === 'Error' && !isset($x60->properties['file']) && !isset($x60->properties['line']) && !isset($x60->properties['column'])) {$x60->properties['file'] = '<image>/08_math.js';$x60->properties['line'] = 53;$x60->properties['column'] = 8;$x60->attributes['file'] = $x60->attributes['line'] = $x60->attributes['column'] = 0; }
throw new JSException($x60, 53, 8, '<image>/08_math.js');
}
unset($x61, $W61, $S61, $U61);
$x62 = _420026a1fb085c6053dae1bd17e9a63a_13($global, $scope, $_arguments, JS::toString($_i, $global), 53, 23, '<image>/08_math.js');
$x61 =& $x62[0]; list(,$W61,$S61,$U61) = $x62;
if (!(is_object($_isNaN) && isset($_isNaN->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x65 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('TypeError', $global), 53, 13, '<image>/08_math.js');
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x67->class) && $x67->class === 'Error' && !isset($x67->properties['file']) && !isset($x67->properties['line']) && !isset($x67->properties['column'])) {$x67->properties['file'] = '<image>/08_math.js';$x67->properties['line'] = 53;$x67->properties['column'] = 13;$x67->attributes['file'] = $x67->attributes['line'] = $x67->attributes['column'] = 0; }
...
$x68 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('NaN', $global), 54, 12, '<image>/08_math.js');
$_NaN =& $x68[0]; list(,$WNaN,$SNaN,$UNaN) = $x68;
if ($UNaN) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x69 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('ReferenceError', $global), 54, 12, '<image>/08_math.js');
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x71->class) && $x71->class === 'Error' && !isset($x71->properties['file']) && !isset($x71->properties['line']) && !isset($x71->properties['column'])) {$x71->properties['file'] = '<image>/08_math.js';$x71->properties['line'] = 54;$x71->properties['column'] = 12;$x71->attributes['file'] = $x71->attributes['line'] = $x71->attributes['column'] = 0; }
throw new JSException($x71, 54, 12, '<image>/08_math.js');
}
return $_NaN;;
};
unset($x75, $W75, $S75, $U75);
$x76 = _420026a1fb085c6053dae1bd17e9a63a_13($global, $scope, $_arguments, JS::toString($_i, $global), 57, 17, '<image>/08_math.js');
...
$x80 = _420026a1fb085c6053dae1bd17e9a63a_13($global, $scope, $_arguments, JS::toString($_i, $global), 58, 20, '<image>/08_math.js');
...
echo 'function _420026a1fb085c6053dae1bd17e9a63a_11($global,$leThis,$fn,$args,$constructor=FALSE){for($x33=0;;++$x33){if($x33===0){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x32=&$scope->properties[\'arguments\'];$x32->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x32->properties[$i]=$args[$i];$x32->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'a\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_a=&$scope->properties[\'a\'];$Ua=FALSE;$scope->properties[\'b\']=array_key_exists(1,$args)?$args[1]:JS::$undefined;$_b=&$scope->properties[\'b\'];$Ub=FALSE;$global->scope[++$global->scope_sp]=$scope;$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x36=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'arguments\',$global),52,23,\'<image>/08_math.js\');$_arguments=&$x36[0];list(,$Warguments,$Sarguments,$Uarguments)=$x36;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x37=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),52,23,\'<image>/08_math.js\');$_ReferenceError=&$x37[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x37;$x38=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/08_math.js\',52,23);$x39=$x38($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x39->class)&&$x39->class===\'Error\'&&!isset($x39->properties[\'file\'])&&!isset($x39->properties[\'line\'])&&!isset($x39->properties[\'column\'])){$x39->properties[\'file\']=\'<image>/08_math.js\';$x39->properties[\'line\']=52;$x39->properties[\'column\']=23;$x39->attributes[\'file\']=$x39->attributes[\'line\']=$x39->attributes[\'column\']=0;}throw new JSException($x39,52,23,\'<image>/08_math.js\');}unset($x40,$W40,$S40,$U40);$x46=_420026a1fb085c6053dae1bd17e9a63a_13($global,$scope,$_arguments,JS::toString(\'length\',$global),52,32,\'<image>/08_math.js\');$x40=&$x46[0];list(,$W40,$S40,$U40)=$x46;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x40;unset($_Infinity,$WInfinity,$SInfinity,$UInfinity);$x47=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'Infinity\',$global),52,48,\'<image>/08_math.js\');$_Infinity=&$x47[0];list(,$WInfinity,$SInfinity,$UInfinity)=$x47;if($UInfinity){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x48=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),52,48,\'<image>/08_math.js\');$_ReferenceError=&$x48[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x48;$x49=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/08_math.js\',52,48);$x50=$x49($global,$global,$_ReferenceError,array(\'Infinity is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x50->class)&&$x50->class===\'Error\'&&!isset($x50->properties[\'file\'])&&!isset($x50->properties[\'line\'])&&!isset($x50->properties[\'column\'])){$x50->properties[\'file\']=\'<image>/08_math.js\';$x50->properties[\'line\']=52;$x50->properties[\'column\']=48;$x50->attributes[\'file\']=$x50->attributes[\'line\']=$x50->attributes[\'column\']=0;}throw new JSException($x50,52,48,\'<image>/08_math.js\');}$scope->properties[\'max\']=JS::$undefined;$_max=&$scope->properties[\'max\'];$Umax=FALSE;$_max=(-1.0*JS::toNumber($_Infinity,$global));}if($x33!==0){$x51=++$_i;}$x52=JS::toPrimitive($_i,$global);$x53=JS::toPrimitive($_l,$global);$x54=(is_string($x52)&&is_string($x53)?strcmp($x52,$x53)<0:(!is_nan($x55=JS::toNumber($x52,$global))&&!is_nan($x56=JS::toNumber($x53,$global))&&$x55<$x56));if(!JS::toBoolean($x54,$global)){break;}unset($_isNaN,$WisNaN,$SisNaN,$UisNaN);$x57=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'isNaN\',$global),53,8,\'<image>/08_math.js\');$_isNaN=&$x57[0];list(,$WisNaN,$SisNaN,$UisNaN)=$x57;if($UisNaN){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x58=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),53,8,\'<image>/08_math.js\');$_ReferenceError=&$x58[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x58;$x59=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/08_math.js\',53,8);$x60=$x59($global,$global,$_ReferenceError,array(\'isNaN is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x60->class)&&$x60->class===\'Error\'&&!isset($x60->properties[\'file\'])&&!isset($x60->properties[\'line\'])&&!isset($x60->properties[\'column\'])){$x60->properties[\'file\']=\'<image>/08_math.js\';$x60->properties[\'line\']=53;$x60->properties[\'column\']=8;$x60->attributes[\'file\']=$x60->attributes[\'line\']=$x60->attributes[\'column\']=0;}throw new JSException($x60,53,8,\'<image>/08_math.js\');}unset($x61,$W61,$S61,$U61);$x62=_420026a1fb085c6053dae1bd17e9a63a_13($global,$scope,$_arguments,JS::toString($_i,$global),53,23,\'<image>/08_math.js\');$x61=&$x62[0];list(,$W61,$S61,$U61)=$x62;if(!(is_object($_isNaN)&&isset($_isNaN->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x65=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'TypeError\',$global),53,13,\'<image>/08_math.js\');$_TypeError=&$x65[0];list(,$WTypeError,$STypeError,$UTypeError)=$x65;$x66=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/08_math.js\',53,13);$x67=$x66($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x67->class)&&$x67->class===\'Error\'&&!isset($x67->properties[\'file\'])&&!isset($x67->properties[\'line\'])&&!isset($x67->properties[\'column\'])){$x67->properties[\'file\']=\'<image>/08_math.js\';$x67->properties[\'line\']=53;$x67->properties[\'column\']=13;$x67->attributes[\'file\']=$x67->attributes[\'line\']=$x67->attributes[\'column\']=0;}throw new JSException($x67,53,13,\'<image>/08_math.js\');}$x63=$_isNaN->call;$global->trace[++$global->trace_sp]=array(\'<image>/08_math.js\',53,13);$x64=$x63($global,$global,$_isNaN,array($x61),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(JS::toBoolean($x64,$global)){unset($_NaN,$WNaN,$SNaN,$UNaN);$x68=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'NaN\',$global),54,12,\'<image>/08_math.js\');$_NaN=&$x68[0];list(,$WNaN,$SNaN,$UNaN)=$x68;if($UNaN){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x69=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),54,12,\'<image>/08_math.js\');$_ReferenceError=&$x69[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x69;$x70=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/08_math.js\',54,12);$x71=$x70($global,$global,$_ReferenceError,array(\'NaN is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x71->class)&&$x71->class===\'Error\'&&!isset($x71->properties[\'file\'])&&!isset($x71->properties[\'line\'])&&!isset($x71->properties[\'column\'])){$x71->properties[\'file\']=\'<image>/08_math.js\';$x71->properties[\'line\']=54;$x71->properties[\'column\']=12;$x71->attributes[\'file\']=$x71->attributes[\'line\']=$x71->attributes[\'column\']=0;}throw new JSException($x71,54,12,\'<image>/08_math.js\');}return$_NaN;}unset($x75,$W75,$S75,$U75);$x76=_420026a1fb085c6053dae1bd17e9a63a_13($global,$scope,$_arguments,JS::toString($_i,$global),57,17,\'<image>/08_math.js\');$x75=&$x76[0];list(,$W75,$S75,$U75)=$x76;$x72=JS::toPrimitive($x75,$global);$x73=JS::toPrimitive($_max,$global);$x74=(is_string($x73)&&is_string($x72)?strcmp($x73,$x72)<0:(!is_nan($x77=JS::toNumber($x73,$global))&&!is_nan($x78=JS::toNumber($x72,$global))&&$x77<$x78));if(JS::toBoolean($x74,$global)){unset($x79,$W79,$S79,$U79);$x80=_420026a1fb085c6053dae1bd17e9a63a_13($global,$scope,$_arguments,JS::toString($_i,$global),58,20,\'<image>/08_math.js\');$x79=&$x80[0];list(,$W79,$S79,$U79)=$x80;if($Umax){$global->properties[\'max\']=$_max;$_max=&$global->properties[\'max\'];}$_max=$x79;}}return$_max;return JS::$undefined;}', "\n";
...
$_i = 0;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x85 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('arguments', $global), 66, 23, '<image>/08_math.js');
$_arguments =& $x85[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x85;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x86 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('ReferenceError', $global), 66, 23, '<image>/08_math.js');
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x88->class) && $x88->class === 'Error' && !isset($x88->properties['file']) && !isset($x88->properties['line']) && !isset($x88->properties['column'])) {$x88->properties['file'] = '<image>/08_math.js';$x88->properties['line'] = 66;$x88->properties['column'] = 23;$x88->attributes['file'] = $x88->attributes['line'] = $x88->attributes['column'] = 0; }
throw new JSException($x88, 66, 23, '<image>/08_math.js');
}
unset($x89, $W89, $S89, $U89);
$x90 = _420026a1fb085c6053dae1bd17e9a63a_13($global, $scope, $_arguments, JS::toString('length', $global), 66, 32, '<image>/08_math.js');
$x89 =& $x90[0]; list(,$W89,$S89,$U89) = $x90;
$scope->properties['l'] = JS::$undefined; $_l =& $scope->properties['l'];
$Ul = FALSE;
$_l = $x89;
unset($_Infinity, $WInfinity, $SInfinity, $UInfinity);
$x91 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('Infinity', $global), 66, 48, '<image>/08_math.js');
$_Infinity =& $x91[0]; list(,$WInfinity,$SInfinity,$UInfinity) = $x91;
if ($UInfinity) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x92 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('ReferenceError', $global), 66, 48, '<image>/08_math.js');
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x94->class) && $x94->class === 'Error' && !isset($x94->properties['file']) && !isset($x94->properties['line']) && !isset($x94->properties['column'])) {$x94->properties['file'] = '<image>/08_math.js';$x94->properties['line'] = 66;$x94->properties['column'] = 48;$x94->attributes['file'] = $x94->attributes['line'] = $x94->attributes['column'] = 0; }
...
unset($_isNaN, $WisNaN, $SisNaN, $UisNaN);
$x101 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('isNaN', $global), 67, 8, '<image>/08_math.js');
$_isNaN =& $x101[0]; list(,$WisNaN,$SisNaN,$UisNaN) = $x101;
if ($UisNaN) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x102 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('ReferenceError', $global), 67, 8, '<image>/08_math.js');
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x104->class) && $x104->class === 'Error' && !isset($x104->properties['file']) && !isset($x104->properties['line']) && !isset($x104->properties['column'])) {$x104->properties['file'] = '<image>/08_math.js';$x104->properties['line'] = 67;$x104->properties['column'] = 8;$x104->attributes['file'] = $x104->attributes['line'] = $x104->attributes['column'] = 0; }
throw new JSException($x104, 67, 8, '<image>/08_math.js');
}
unset($x105, $W105, $S105, $U105);
$x106 = _420026a1fb085c6053dae1bd17e9a63a_13($global, $scope, $_arguments, JS::toString($_i, $global), 67, 23, '<image>/08_math.js');
$x105 =& $x106[0]; list(,$W105,$S105,$U105) = $x106;
if (!(is_object($_isNaN) && isset($_isNaN->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x109 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('TypeError', $global), 67, 13, '<image>/08_math.js');
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x111->class) && $x111->class === 'Error' && !isset($x111->properties['file']) && !isset($x111->properties['line']) && !isset($x111->properties['column'])) {$x111->properties['file'] = '<image>/08_math.js';$x111->properties['line'] = 67;$x111->properties['column'] = 13;$x111->attributes['file'] = $x111->attributes['line'] = $x111->attributes['column'] = 0; }
...
unset($_NaN, $WNaN, $SNaN, $UNaN);
$x112 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('NaN', $global), 68, 12, '<image>/08_math.js');
$_NaN =& $x112[0]; list(,$WNaN,$SNaN,$UNaN) = $x112;
if ($UNaN) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x113 = _420026a1fb085c6053dae1bd17e9a63a_12($global, $scope, $scope, JS::toString('ReferenceError', $global), 68, 12, '<image>/08_math.js');
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x115->class) && $x115->class === 'Error' && !isset($x115->properties['file']) && !isset($x115->properties['line']) && !isset($x115->properties['column'])) {$x115->properties['file'] = '<image>/08_math.js';$x115->properties['line'] = 68;$x115->properties['column'] = 12;$x115->attributes['file'] = $x115->attributes['line'] = $x115->attributes['column'] = 0; }
throw new JSException($x115, 68, 12, '<image>/08_math.js');
}
return $_NaN;;
};
unset($x119, $W119, $S119, $U119);
$x120 = _420026a1fb085c6053dae1bd17e9a63a_13($global, $scope, $_arguments, JS::toString($_i, $global), 71, 17, '<image>/08_math.js');
...
$x124 = _420026a1fb085c6053dae1bd17e9a63a_13($global, $scope, $_arguments, JS::toString($_i, $global), 72, 20, '<image>/08_math.js');
...
echo 'function _420026a1fb085c6053dae1bd17e9a63a_14($global,$leThis,$fn,$args,$constructor=FALSE){for($x84=0;;++$x84){if($x84===0){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x83=&$scope->properties[\'arguments\'];$x83->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x83->properties[$i]=$args[$i];$x83->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'a\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_a=&$scope->properties[\'a\'];$Ua=FALSE;$scope->properties[\'b\']=array_key_exists(1,$args)?$args[1]:JS::$undefined;$_b=&$scope->properties[\'b\'];$Ub=FALSE;$global->scope[++$global->scope_sp]=$scope;$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x85=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'arguments\',$global),66,23,\'<image>/08_math.js\');$_arguments=&$x85[0];list(,$Warguments,$Sarguments,$Uarguments)=$x85;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x86=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),66,23,\'<image>/08_math.js\');$_ReferenceError=&$x86[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x86;$x87=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/08_math.js\',66,23);$x88=$x87($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x88->class)&&$x88->class===\'Error\'&&!isset($x88->properties[\'file\'])&&!isset($x88->properties[\'line\'])&&!isset($x88->properties[\'column\'])){$x88->properties[\'file\']=\'<image>/08_math.js\';$x88->properties[\'line\']=66;$x88->properties[\'column\']=23;$x88->attributes[\'file\']=$x88->attributes[\'line\']=$x88->attributes[\'column\']=0;}throw new JSException($x88,66,23,\'<image>/08_math.js\');}unset($x89,$W89,$S89,$U89);$x90=_420026a1fb085c6053dae1bd17e9a63a_13($global,$scope,$_arguments,JS::toString(\'length\',$global),66,32,\'<image>/08_math.js\');$x89=&$x90[0];list(,$W89,$S89,$U89)=$x90;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x89;unset($_Infinity,$WInfinity,$SInfinity,$UInfinity);$x91=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'Infinity\',$global),66,48,\'<image>/08_math.js\');$_Infinity=&$x91[0];list(,$WInfinity,$SInfinity,$UInfinity)=$x91;if($UInfinity){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x92=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),66,48,\'<image>/08_math.js\');$_ReferenceError=&$x92[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x92;$x93=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/08_math.js\',66,48);$x94=$x93($global,$global,$_ReferenceError,array(\'Infinity is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x94->class)&&$x94->class===\'Error\'&&!isset($x94->properties[\'file\'])&&!isset($x94->properties[\'line\'])&&!isset($x94->properties[\'column\'])){$x94->properties[\'file\']=\'<image>/08_math.js\';$x94->properties[\'line\']=66;$x94->properties[\'column\']=48;$x94->attributes[\'file\']=$x94->attributes[\'line\']=$x94->attributes[\'column\']=0;}throw new JSException($x94,66,48,\'<image>/08_math.js\');}$scope->properties[\'min\']=JS::$undefined;$_min=&$scope->properties[\'min\'];$Umin=FALSE;$_min=(+JS::toNumber($_Infinity,$global));}if($x84!==0){$x95=++$_i;}$x96=JS::toPrimitive($_i,$global);$x97=JS::toPrimitive($_l,$global);$x98=(is_string($x96)&&is_string($x97)?strcmp($x96,$x97)<0:(!is_nan($x99=JS::toNumber($x96,$global))&&!is_nan($x100=JS::toNumber($x97,$global))&&$x99<$x100));if(!JS::toBoolean($x98,$global)){break;}unset($_isNaN,$WisNaN,$SisNaN,$UisNaN);$x101=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'isNaN\',$global),67,8,\'<image>/08_math.js\');$_isNaN=&$x101[0];list(,$WisNaN,$SisNaN,$UisNaN)=$x101;if($UisNaN){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x102=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),67,8,\'<image>/08_math.js\');$_ReferenceError=&$x102[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x102;$x103=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/08_math.js\',67,8);$x104=$x103($global,$global,$_ReferenceError,array(\'isNaN is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x104->class)&&$x104->class===\'Error\'&&!isset($x104->properties[\'file\'])&&!isset($x104->properties[\'line\'])&&!isset($x104->properties[\'column\'])){$x104->properties[\'file\']=\'<image>/08_math.js\';$x104->properties[\'line\']=67;$x104->properties[\'column\']=8;$x104->attributes[\'file\']=$x104->attributes[\'line\']=$x104->attributes[\'column\']=0;}throw new JSException($x104,67,8,\'<image>/08_math.js\');}unset($x105,$W105,$S105,$U105);$x106=_420026a1fb085c6053dae1bd17e9a63a_13($global,$scope,$_arguments,JS::toString($_i,$global),67,23,\'<image>/08_math.js\');$x105=&$x106[0];list(,$W105,$S105,$U105)=$x106;if(!(is_object($_isNaN)&&isset($_isNaN->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x109=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'TypeError\',$global),67,13,\'<image>/08_math.js\');$_TypeError=&$x109[0];list(,$WTypeError,$STypeError,$UTypeError)=$x109;$x110=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/08_math.js\',67,13);$x111=$x110($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x111->class)&&$x111->class===\'Error\'&&!isset($x111->properties[\'file\'])&&!isset($x111->properties[\'line\'])&&!isset($x111->properties[\'column\'])){$x111->properties[\'file\']=\'<image>/08_math.js\';$x111->properties[\'line\']=67;$x111->properties[\'column\']=13;$x111->attributes[\'file\']=$x111->attributes[\'line\']=$x111->attributes[\'column\']=0;}throw new JSException($x111,67,13,\'<image>/08_math.js\');}$x107=$_isNaN->call;$global->trace[++$global->trace_sp]=array(\'<image>/08_math.js\',67,13);$x108=$x107($global,$global,$_isNaN,array($x105),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(JS::toBoolean($x108,$global)){unset($_NaN,$WNaN,$SNaN,$UNaN);$x112=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'NaN\',$global),68,12,\'<image>/08_math.js\');$_NaN=&$x112[0];list(,$WNaN,$SNaN,$UNaN)=$x112;if($UNaN){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x113=_420026a1fb085c6053dae1bd17e9a63a_12($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),68,12,\'<image>/08_math.js\');$_ReferenceError=&$x113[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x113;$x114=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/08_math.js\',68,12);$x115=$x114($global,$global,$_ReferenceError,array(\'NaN is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x115->class)&&$x115->class===\'Error\'&&!isset($x115->properties[\'file\'])&&!isset($x115->properties[\'line\'])&&!isset($x115->properties[\'column\'])){$x115->properties[\'file\']=\'<image>/08_math.js\';$x115->properties[\'line\']=68;$x115->properties[\'column\']=12;$x115->attributes[\'file\']=$x115->attributes[\'line\']=$x115->attributes[\'column\']=0;}throw new JSException($x115,68,12,\'<image>/08_math.js\');}return$_NaN;}unset($x119,$W119,$S119,$U119);$x120=_420026a1fb085c6053dae1bd17e9a63a_13($global,$scope,$_arguments,JS::toString($_i,$global),71,17,\'<image>/08_math.js\');$x119=&$x120[0];list(,$W119,$S119,$U119)=$x120;$x116=JS::toPrimitive($x119,$global);$x117=JS::toPrimitive($_min,$global);$x118=(is_string($x116)&&is_string($x117)?strcmp($x116,$x117)<0:(!is_nan($x121=JS::toNumber($x116,$global))&&!is_nan($x122=JS::toNumber($x117,$global))&&$x121<$x122));if(JS::toBoolean($x118,$global)){unset($x123,$W123,$S123,$U123);$x124=_420026a1fb085c6053dae1bd17e9a63a_13($global,$scope,$_arguments,JS::toString($_i,$global),72,20,\'<image>/08_math.js\');$x123=&$x124[0];list(,$W123,$S123,$U123)=$x124;if($Umin){$global->properties[\'min\']=$_min;$_min=&$global->properties[\'min\'];}$_min=$x123;}}return$_min;return JS::$undefined;}', "\n";
