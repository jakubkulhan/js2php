...
test("Object.seal(), Object.isSealed()", function () {
	var o = { one: 1, two: 2 };
...
test("Object.freeze(), Object.isFrozen()", function () {
	var o = { one: 1, two: 2 };
...
test("Object.preventExtensions(), Object.isExtensible()", function () {
	var o = { one: 1, two: 2 };
...
test("Object.prototype.propertyIsEnumerable()", function () {
