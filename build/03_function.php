...
$x10 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', $line, $column, $file);
...
$x5 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'arguments', 4, 6, '<image>/03_function.js');
$_arguments =& $x5[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x5;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x6 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'ReferenceError', 4, 6, '<image>/03_function.js');
...
unset($x9, $W9, $S9, $U9);
$x15 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_arguments, (string) 'length', 4, 15, '<image>/03_function.js');
...
$x22 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_arguments, (string) 'length', 5, 32, '<image>/03_function.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x26 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', 6, 13, '<image>/03_function.js');
...
$x30 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $x25, (string) 'push', 6, 13, '<image>/03_function.js');
$x29 =& $x30[0]; list(,$W29,$S29,$U29) = $x30;
unset($x31, $W31, $S31, $U31);
$x32 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_arguments, (string) $_i, 6, 23, '<image>/03_function.js');
$x31 =& $x32[0]; list(,$W31,$S31,$U31) = $x32;
if (!(is_object($x29) && isset($x29->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x35 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', 6, 13, '<image>/03_function.js');
...
$x39 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_arguments, (string) 'length', 9, 29, '<image>/03_function.js');
$x38 =& $x39[0]; list(,$W38,$S38,$U38) = $x39;
unset($x40, $W40, $S40, $U40);
$x41 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_arguments, (string) (JS::toNumber($x38, $global) - JS::toNumber(1, $global)), 9, 19, '<image>/03_function.js');
...
if ($_args === JS::$undefined || $_args === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x43 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', 12, 18, '<image>/03_function.js');
...
$x47 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $x42, (string) 'join', 12, 18, '<image>/03_function.js');
$x46 =& $x47[0]; list(,$W46,$S46,$U46) = $x47;
if (!(is_object($x46) && isset($x46->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x50 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', 12, 18, '<image>/03_function.js');
...
$x64 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'SyntaxError', 21, 14, '<image>/03_function.js');
$_SyntaxError =& $x64[0]; list(,$WSyntaxError,$SSyntaxError,$USyntaxError) = $x64;
if ($USyntaxError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x65 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'ReferenceError', 21, 14, '<image>/03_function.js');
...
$x79 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_SyntaxError, (string) 'prototype', 21, 10, '<image>/03_function.js');
$x78 =& $x79[0]; list(,$W78,$S78,$U78) = $x79;
$x63 = $x78;
$x62->prototype = $x63;
if (!(is_object($_SyntaxError) && isset($_SyntaxError->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x82 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', 21, 10, '<image>/03_function.js');
...
if ($base === JS::$undefined || $base === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x93 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', $line, $column, $file);
...
$x142 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_argArray, (string) 'length', 76, 30, '<image>/03_function.js');
...
$x150 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_argArray, (string) $_i, 77, 17, '<image>/03_function.js');
...
$_i = 1;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x172 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'arguments', 96, 22, '<image>/03_function.js');
$_arguments =& $x172[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x172;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x173 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'ReferenceError', 96, 22, '<image>/03_function.js');
...
$x177 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_arguments, (string) 'length', 96, 31, '<image>/03_function.js');
...
$x185 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_arguments, (string) $_i, 97, 18, '<image>/03_function.js');
...
$_i = 1;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x200 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'arguments', 111, 22, '<image>/03_function.js');
$_arguments =& $x200[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x200;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x201 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'ReferenceError', 111, 22, '<image>/03_function.js');
...
$x205 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_arguments, (string) 'length', 111, 31, '<image>/03_function.js');
...
$x213 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_arguments, (string) $_i, 112, 18, '<image>/03_function.js');
$x212 =& $x213[0]; list(,$W212,$S212,$U212) = $x213;
if ($Uarg) {$global->properties['arg'] = $_arg; $_arg =& $global->properties['arg']; }
$_arg = $x212;
$boundArgs[] =$_arg;
unset($x214, $W214, $S214, $U214);
$x215 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_newFn, (string) 'length', 114, 10, '<image>/03_function.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x89 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', 40, 20, '<image>/03_function.js');
...
$x96 = _8cc783701129b82efc0bf45cf12c568e_5($global, $scope, $_Function, (string) 'prototype', 40, 20, '<image>/03_function.js');
...
$x100 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'Object', 41, 53, '<image>/03_function.js');
$_Object =& $x100[0]; list(,$WObject,$SObject,$UObject) = $x100;
if ($UObject) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x101 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'ReferenceError', 41, 53, '<image>/03_function.js');
...
$x105 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_Function, (string) 'prototype', 44, 9, '<image>/03_function.js');
$x104 =& $x105[0]; list(,$W104,$S104,$U104) = $x105;
if ($x104 === JS::$undefined || $x104 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x106 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', 44, 32, '<image>/03_function.js');
...
$x110 = _8cc783701129b82efc0bf45cf12c568e_5($global, $scope, $x104, (string) 'constructor', 44, 32, '<image>/03_function.js');
...
$x118 = clone JS::$functionTemplate; $x118->call = '_8cc783701129b82efc0bf45cf12c568e_6'; $x118->parameters = array (
...
$x120 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_Function, (string) 'prototype', 54, 9, '<image>/03_function.js');
$x119 =& $x120[0]; list(,$W119,$S119,$U119) = $x120;
if ($x119 === JS::$undefined || $x119 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x121 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', 54, 29, '<image>/03_function.js');
...
$x125 = _8cc783701129b82efc0bf45cf12c568e_5($global, $scope, $x119, (string) 'toString', 54, 29, '<image>/03_function.js');
...
$x151 = clone JS::$functionTemplate; $x151->call = '_8cc783701129b82efc0bf45cf12c568e_7'; $x151->parameters = array (
  0 => 'thisArg',
  1 => 'argArray',
...
$x153 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_Function, (string) 'prototype', 64, 9, '<image>/03_function.js');
$x152 =& $x153[0]; list(,$W152,$S152,$U152) = $x153;
if ($x152 === JS::$undefined || $x152 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x154 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', 64, 26, '<image>/03_function.js');
...
$x158 = _8cc783701129b82efc0bf45cf12c568e_5($global, $scope, $x152, (string) 'apply', 64, 26, '<image>/03_function.js');
...
$x186 = clone JS::$functionTemplate; $x186->call = '_8cc783701129b82efc0bf45cf12c568e_8'; $x186->parameters = array (
  0 => 'thisArg',
...
$x188 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_Function, (string) 'prototype', 85, 9, '<image>/03_function.js');
$x187 =& $x188[0]; list(,$W187,$S187,$U187) = $x188;
if ($x187 === JS::$undefined || $x187 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x189 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', 85, 25, '<image>/03_function.js');
...
$x193 = _8cc783701129b82efc0bf45cf12c568e_5($global, $scope, $x187, (string) 'call', 85, 25, '<image>/03_function.js');
...
$x217 = clone JS::$functionTemplate; $x217->call = '_8cc783701129b82efc0bf45cf12c568e_9'; $x217->parameters = array (
  0 => 'thisArg',
...
$x219 = _8cc783701129b82efc0bf45cf12c568e_3($global, $scope, $_Function, (string) 'prototype', 105, 9, '<image>/03_function.js');
$x218 =& $x219[0]; list(,$W218,$S218,$U218) = $x219;
if ($x218 === JS::$undefined || $x218 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x220 = _8cc783701129b82efc0bf45cf12c568e_2($global, $scope, $scope, (string) 'TypeError', 105, 25, '<image>/03_function.js');
...
$x224 = _8cc783701129b82efc0bf45cf12c568e_5($global, $scope, $x218, (string) 'bind', 105, 25, '<image>/03_function.js');
