...
$x48 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_4($global, $scope, $_v, (string) 'length', 30, 22, '<image>/14_dump.js');
...
$x52 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_4($global, $scope, $_v, (string) $_i, 31, 23, '<image>/14_dump.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x57 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_3($global, $scope, $scope, (string) 'TypeError', 31, 21, '<image>/14_dump.js');
...
$x61 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_4($global, $scope, $_d, (string) 'multiline', 31, 43, '<image>/14_dump.js');
...
$x63 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_4($global, $scope, $_d, (string) 'dump', 35, 11, '<image>/14_dump.js');
...
$x66 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_4($global, $scope, $_v, (string) $_k, 42, 23, '<image>/14_dump.js');
$x65 =& $x66[0]; list(,$W65,$S65,$U65) = $x66;
$x67 = JS::toPrimitive($_indent, $global);
$x68 = JS::toPrimitive('  ', $global);
if (!(is_object($_dumper) && isset($_dumper->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x71 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_3($global, $scope, $scope, (string) 'TypeError', 42, 21, '<image>/14_dump.js');
...
$x75 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_4($global, $scope, $_d, (string) 'multiline', 42, 43, '<image>/14_dump.js');
...
$x77 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_4($global, $scope, $_d, (string) 'dump', 46, 11, '<image>/14_dump.js');
...
$global->scope[++$global->scope_sp] = $scope;
$x87 = clone JS::$functionTemplate; $x87->call = '_c83e9377c6c0d7a8f5fa3f20ba99dd2e_2'; $x87->parameters = array (
  0 => 'v',
  1 => 'indent',
...
$x89 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_3($global, $scope, $scope, (string) 'arguments', 67, 22, '<image>/14_dump.js');
$_arguments =& $x89[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x89;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x90 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_3($global, $scope, $scope, (string) 'ReferenceError', 67, 22, '<image>/14_dump.js');
...
$x94 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_4($global, $scope, $_arguments, (string) 'length', 67, 31, '<image>/14_dump.js');
...
$x103 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_4($global, $scope, $_arguments, (string) $_i, 68, 25, '<image>/14_dump.js');
$x102 =& $x103[0]; list(,$W102,$S102,$U102) = $x103;
if (!(is_object($_dumper) && isset($_dumper->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x106 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_3($global, $scope, $scope, (string) 'TypeError', 68, 15, '<image>/14_dump.js');
...
$x110 = _c83e9377c6c0d7a8f5fa3f20ba99dd2e_4($global, $scope, $x105, (string) 'dump', 68, 29, '<image>/14_dump.js');
...
$leThis = $global;
$x111 = clone JS::$functionTemplate; $x111->call = '_c83e9377c6c0d7a8f5fa3f20ba99dd2e_1'; $x111->parameters = array (
