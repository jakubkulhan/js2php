...
test("Array.prototype.concat()", function () {
	var a = [];
...
test("Array.prototype.push()", function () {
	var a = [];
	a.push(1);
...
test("Array.prototype.unshift()", function () {
	var a = [1, 2];
...
test("Array.prototype.slice()", function () {
...
test("Array.prototype.sort()", function () {
	var a = [2, 4, 3, 5, 1], b;
	b = a.sort();
...
test("Array.prototype.splice()", function () {
	var a = [1, 2, 3], b;
	b = a.splice(0, 3);
