...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x8->class) && $x8->class === 'Error' && !isset($x8->properties['file']) && !isset($x8->properties['line']) && !isset($x8->properties['column'])) {$x8->properties['file'] = '<image>/15_backtrace.js';$x8->properties['line'] = 6;$x8->properties['column'] = 17;$x8->attributes['file'] = $x8->attributes['line'] = $x8->attributes['column'] = 0; }
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x21->class) && $x21->class === 'Error' && !isset($x21->properties['file']) && !isset($x21->properties['line']) && !isset($x21->properties['column'])) {$x21->properties['file'] = '<image>/15_backtrace.js';$x21->properties['line'] = 6;$x21->properties['column'] = 17;$x21->attributes['file'] = $x21->attributes['line'] = $x21->attributes['column'] = 0; }
